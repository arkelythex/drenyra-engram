...
- OIDC, signed service assertions, adjudicable judgments, Ed25519 receipts and
  offline verification remain later v0.4.0 steps (ADR-003 direction applies;
  their data/policy contracts are not frozen here).
