...
func TestCLIDoctorReportsPurgeLifecycle(t *testing.T) {
	...
	if report.SchemaVersion != 15 || report.PurgeRequests != 1 || report.PurgeApprovals != 1 || report.PurgeExecutions != 1 {
		t.Fatalf("doctor report = %+v, want schemaVersion 15 and lifecycle counts (1,1,1)", report)
	}
